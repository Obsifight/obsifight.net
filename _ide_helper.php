 ...
 * Generated for Laravel 5.4.21 on 2017-08-08.
 *
...
namespace Waavi\ReCaptcha\Facades { 
    ...
    class ReCaptcha {
         ...
         * @param  string $input
         *
         * @return \Waavi\ReCaptcha\IO\Response 
         * @static 
         */ 
        public static function parseInput($input)
        {
            return \Waavi\ReCaptcha\ReCaptcha::parseInput($input);
        }
        ...
        {
            return \Waavi\ReCaptcha\ReCaptcha::render($options);
        }
...
namespace  { 
    ...
    class ReCaptcha extends \Waavi\ReCaptcha\Facades\ReCaptcha {}
