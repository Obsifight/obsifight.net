<?php
return [
  'description.title' => "ObsiFight ? C'est quoi ?",
  'description' => "<p><b>ObsiFight</b> , tout d'abord, c'est plus de deux ans d'existence, sur cinq versions.</p>
  ...
  'trailer.title' => 'Nous sommes actuellement en version 6 !',
  'trailer.subtitle' => 'Découvrez dès maintenant notre trailer'
];
